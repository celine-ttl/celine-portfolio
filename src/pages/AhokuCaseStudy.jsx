...
function Pill({ text }) {
  return (
    <div className="flex flex-row justify-center items-center w-fit rounded-full text-white text-[12px] font-semibold leading-[27px] uppercase" style={{ ...dm, background: '#4A77FF', padding: '2px 14px', letterSpacing: '0.08em' }}>
      {text}
    </div>
  )
}
...
function CalloutCard({ pill, body }) {
  return (
    <div className="flex flex-col gap-[12px] rounded-[24px] bg-white" style={{ padding: 24, boxShadow: '2px 2px 10px 0px rgba(0,0,0,0.03), -2px -2px 10px 0px rgba(0,0,0,0.03)', border: '1px solid #ECEEEE' }}>
      <Pill text={pill} />
        ...
        <div className="ahoku-hero-inner flex flex-col gap-[32px]" style={{ maxWidth: 1080, width: '100%', padding: '40px 0' }}>
          ...
          <div className="flex flex-col md:flex-row items-center" style={{ gap: 48 }}>
            ...
            <img
              ...
              style={{ maxWidth: 464, height: 307, objectFit: 'cover', borderRadius: 17, flexShrink: 0 }}
            />
          </div>
          {/* Metadata row */}
          <div className="ahoku-meta flex justify-between rounded-[24px]" style={{ background: '#F3F3F3', padding: '24px 72px' }}>
            {[
      ...
      <main>
        ...
        <section id="context" className="flex flex-col items-center bg-white" style={{ position: 'relative', padding: '60px 55px', gap: 24, overflow: 'visible' }}>
          <div className="flex flex-col gap-[32px] fade-section" style={{ maxWidth: 920, width: '100%' }}>
            ...
            <div className="flex flex-col md:flex-row items-center" style={{ gap: 32 }}>
              <img
                src="/images/ahoku/device-proportion-diagram.png"
                alt="ANT device proportion diagram"
                className="w-full md:w-auto"
                style={{ maxWidth: 480, objectFit: 'contain', flexShrink: 0 }}
              />
          ...
          <div className="flex flex-col gap-[24px] fade-section" style={{ maxWidth: 920, width: '100%' }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-[24px]">
              {[
                ...
                <div key={pill} className="flex flex-col gap-[12px] bg-white rounded-[24px]" style={{ padding: 24, boxShadow: '2px 2px 10px 0px rgba(0,0,0,0.03), -2px -2px 10px 0px rgba(0,0,0,0.03)', border: '1px solid #ECEEEE' }}>
                  <Pill text={pill} />
